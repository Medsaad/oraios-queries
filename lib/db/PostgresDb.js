    ...
    exec(connection, queryString, operation) {
        return new Promise((resolve, reject) => {
            ...
            connection.query(queryString)
                .then((data) => {
                    const res = this.handleResponse(data, operation);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
                });

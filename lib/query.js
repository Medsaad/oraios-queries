...
const { escapeHtml, sanitizeString } = require('./parser/validators');
...
class QueryBuilder {
	...
	setMany(data) {
		if (!Array.isArray(data)) {
			throw new Error(`setMany() parameter one should be an array, ${typeof data} given.`);
		}

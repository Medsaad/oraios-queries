...
class WhereParser {
    ...
    readStatement(condition) {
        ...
        if (typeof condition[2] == 'string' && condition[2] !== 'null')
            //parse and santize string for condition values
            if (this.allowedHtml.includes(condition[0])) condition[2] = "'" + condition[2] + "'";
            else condition[2] = "'" + escapeHtml(condition[2]) + "'";
